...
class Camera:
	...
	def update(self, screen, map, player):
		# Centro como referencia para el scroll apartir de la esquina superior izquierda del tile del player.
		
		### NOTA . Equivale a jugador_posabs pero este es topleft.
		...
		# con esto definimos el rango de tiles que debe ser dibujado.
